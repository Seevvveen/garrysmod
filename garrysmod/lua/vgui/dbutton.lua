...
local FinishedDButton = derma.DefineControl( "DButton", "A standard Button", PANEL, "DLabel" )

PANEL = table.Copy( FinishedDButton )

function PANEL:SetActionFunction( func )

	self.DoClick = function( slf ) func( slf, "Command", 0, 0 ) end

end

-- Needs to be empty to prevent duplicate example being generated by DButtons GenerateExample Function
